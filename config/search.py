...
search_terms = ["Software Engineer Intern", "Machine Learning Intern", "Machine Learning Engineer Intern", "AI Engineer Intern", "Artificial Intelligence Intern", "Generative AI Intern", "LLM Engineer Intern", "NLP Intern", "Computer Vision Intern", "Data Scientist Intern", "Data Analyst Intern", "Data Engineer Intern", "DevOps Intern", "Cloud Engineer Intern"]
...
job_type = ["Internship", "Full-time", "Contract"]                      # (multiple select) "Full-time", "Part-time", "Contract", "Temporary", "Volunteer", "Internship", "Other"
on_site = ["On-site", "Remote", "Hybrid"]                       # (multiple select) "On-site", "Remote", "Hybrid"

companies = ["7-eleven", "Google","X, the moonshot factory","YouTube","CapitalG","Adometry (acquired by Google)","Meta","Apple","Byte Dance","Netflix", "Snowflake","Mineral.ai","Microsoft","JP Morgan","Barclays","Visa","American Express", "Snap Inc", "JPMorgan Chase & Co.", "Tata Consultancy Services", "Recruiting from Scratch", "Epic"]                     # (dynamic multiple select) make sure the name you type in list exactly matches with the company name you're looking for, including capitals. 
...
industry = ["Software Development", "Information Technology & Services","IT"]                      # (dynamic multiple select)
job_function = ["Engineering", "Information Technology","IT"]                  # (dynamic multiple select)
